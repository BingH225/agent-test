...
def _state_to_view(state: SmartStressState) -> SmartStressStateView:
    return SmartStressStateView(
        ...
        tool_execution_mode=state.get("tool_execution_mode"),
        external_side_effects=state.get("external_side_effects", False),
        ...
        refinement_requested=state.get("refinement_requested", False),
        safety_escalation=state.get("safety_escalation", False),
        orchestration_decision=state.get("orchestration_decision"),
        orchestration_reason=state.get("orchestration_reason"),
        orchestration_signals=dict(state.get("orchestration_signals", {})),
